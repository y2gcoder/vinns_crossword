...
public class CreateCrossword {
	public static int getIndexCurrentLetter(char[][] grid, int i, int j, boolean lookVerticalDirection) {
		int index = 0;
	...
	public static List<String> getPossibleWords(String[] words, Set<String> set, char character, int characterIndex) {
	...
	public static boolean fillGrid(Set<String> set, String[] words, char[][] grid, String word, int character, int i,
	...
	public static void fillGrid(char[][] grid, String[] words, Set<String> set) {
		int i = 0, j = 0;
